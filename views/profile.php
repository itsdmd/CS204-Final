...
<div class="container mt-5 p-5">
                ...
                <div class="modal-dialog" role="document">
                    <div class="modal-content">
                        ...
                        <div class="modal-body">
                            <!-- upload file form -->
                            <div>
                                <form action="<?= ROOT . "upload/avatar" ?>"
    ...
    <div class="row">
        <div class="col-12">
            <a href="<?= ROOT ?>posts/create" class="btn btn-info"><i
            ...
            <table class="table table-bordered table-striped mt-3">
                ...
                <tbody>
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex">
                                ...
                                <button class="btn btn-outline-warning ml-1"
                                    type="button"
                                    onclick="location.href='<?= ROOT; ?>posts/edit/<?= $post['id']; ?>'">
                                    <i class="fa-solid fa-pen"></i>
                                    <!-- <b>Edit</b> -->
                                </button>

                                <form method="post"
                                    action="<?= ROOT ?>posts/delete">
                                    <button type="submit" name="post-id"
                                        value="<?= $post["id"] ?>"
                                        class="btn btn-outline-danger ml-1"><i
                        ...
                        <td>
                            <p class="text-<?= ($voting_score > 0) ? "success" : (($voting_score == 0) ? "secondary" : "danger") ?>"
                    ...
                    <tr>
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                ...
                                <?php if ($post_count > 0) : ?>
                                <form action="<?= ROOT . 'posts/search' ?>"
                                    method="get">
                                    <input type="hidden" name="type"
                                        value="author">
                                    <input type="hidden" name="needle"
                                        value="<?= $user["username"] ?>">
                                    <button type="submit"
                                        class="btn btn-outline-info ml-1"><i
                        ...
                        <td>
                            <div class="d-flex justify-content-between">
                                <p class="text-<?= ($report_count < 5) ? "secondary" : "danger" ?>"
                                    style="font-size: 1.2rem;">
                                    <b><?= $report_count ?></b>
                                </p>

                                <?php if ($report_count > 0) : ?>
                                <form action="<?= ROOT . 'posts' ?>"
                                    method="post">
                                    <input type="hidden" name="ids"
                                        value="<?= implode(",", $reported_posts_id) ?>">
                                    <button type="submit"
                                        class="btn btn-outline-info ml-1"><i
                                            class="fa-solid fa-eye"></i></button>
                                    <!-- <b>View</b> -->
...
<div class=" container p-5">
    <div class="row">
        <div class="col-12">
            <a href="<?= ROOT ?>logout" class="btn btn-danger"><i
